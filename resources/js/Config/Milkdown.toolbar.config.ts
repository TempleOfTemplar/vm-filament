...
export const defaultMilkdownToolbarConfig: Config = [
    [
        {
            type: 'button',
            icon: 'undo',
    ...
    [
        {
            ...
            onSelect: (id: string | number) => (Number(id) ? ['TurnIntoHeading', Number(id)] : ['TurnIntoText', null]),
        },
    ],
    [
        {
        ...
        },
        {
            ...
            active: (view: any) => hasMark(view.state, view.state.schema.marks['strike_through']),
